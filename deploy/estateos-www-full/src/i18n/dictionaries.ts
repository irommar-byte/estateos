...
export type Dictionary = {
  ...
  intelligence: {
    ...
    sheetTitle: string;
    sheetBody: string;
    sheetFeature1: string;
    sheetFeature2: string;
...
const pl: Dictionary = {
  ...
  homeAppPitch: {
    ...
    androidSoon: "Wkrótce dostępny",
    androidBetaLabel: "Pobierz na Androida",
    androidBetaBadge: "Beta",
    androidBetaHint:
      "Aplikacja na Androida będzie wkrótce dostępna.",
  },
  pulse: {
    title: "Puls rynku",
...
const en: Dictionary = {
  ...
  homeAppPitch: {
    ...
    androidBetaBadge: "Beta",
    androidBetaHint:
      "The Android app will be available soon.",
  },
  pulse: {
    title: "Market pulse",
