                ...
                <div className="flex flex-col gap-2.5 relative z-10">
                  ...
                  >
                    ...
                    <span className="relative z-10 flex items-center gap-3 text-lg sm:text-xl font-black tracking-tight" style={{ color: '#000000' }}>
                      <Briefcase size={22} style={{ color: '#000000' }} /> Złóż Ofertę Zakupu
                    </span>
      ...
      <AnimatePresence>
        {isGalleryOpen && (
          <motion.div 
            ...
            className="fixed inset-0 z-[999999] bg-black/95 backdrop-blur-xl flex flex-col items-center justify-center"
